webpackHotUpdate("static/development/pages/animes/[animeId]/episodes/[episodeId].js",{
...
animeStreaming.getInitialProps = function _callee(ctx) {
  var episodeId, res, anime, episodesLink, res2, episodes, previousLink, previousPage, nextPage, nextLink;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("https://api.id-anime.net/v1/episodes/".concat(episodeId)));
...
//# sourceMappingURL=[episodeId].js.332f54a9d73d6a9f09c6.hot-update.js.map